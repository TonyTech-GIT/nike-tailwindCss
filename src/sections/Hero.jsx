...
const Hero = () => {
    ...
    return (
        <section id="home" className="w-full flex xl:flex-row flex-col justify-center gap-10 max-container min-h-screen ">
            ...
            <div className="xl:w-2/5 flex flex-col justify-center items-start w-full max-lg:padding-x pt-28">
                ...
                <p className="font-montserrat text-slate-gray leading-8  text-lg mt-6 mb-14 sm:max-w-sm">Discover stylish Nike arrivals, quality comfort, and innovation for your active life.
                </p>
